...
ref.orderByKey().startAt("199001000001").on("value", function(snapshot) {

    var cache = Object.values(snapshot.val());
    ...
    x.domain(d3.extent(casesSum, function(d) { console.log(d.key);
        return d.key; }));
    y.domain(d3.extent(casesSum, function(d) {
        return d.value; }));
